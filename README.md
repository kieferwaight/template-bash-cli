...
The [North Star](docs/north-star.md) defines the project's long-term direction, ownership boundaries, and evidence gates. Significant architectural choices are recorded in the [decision log](docs/decisions/README.md). The [ecosystem map](docs/ecosystem.md) explains how this repository coordinates with devkit and the public Homebrew tap.
